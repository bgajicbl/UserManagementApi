...
import io.swagger.client.model.Province;
...
public class InlineResponse2005 extends CommonResp {
  @SerializedName("data")
  private List<Province> data = null;

  public InlineResponse2005 data(List<Province> data) {
    this.data = data;
    return this;
  }

  public InlineResponse2005 addDataItem(Province dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<Province>();
    }
