...
public class InlineResponse2004 extends CommonResp {
  @SerializedName("data")
  private List<Country> data = null;

  public InlineResponse2004 data(List<Country> data) {
    this.data = data;
    return this;
  }

  public InlineResponse2004 addDataItem(Country dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<Country>();
    }
