...
import io.swagger.client.model.BusinessType;
...
public class InlineResponse2002 extends CommonResp {
  @SerializedName("data")
  private List<BusinessType> data = null;

  public InlineResponse2002 data(List<BusinessType> data) {
    this.data = data;
    return this;
  }

  public InlineResponse2002 addDataItem(BusinessType dataItem) {
    if (this.data == null) {
      this.data = new ArrayList<BusinessType>();
    }
